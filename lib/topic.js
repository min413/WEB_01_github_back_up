    ...
    db.query(`SELECT * FROM topic WHERE id=?`,[queryData.id], function(error2,topic){
      ...
      db.query(`SELECT * FROM author`, function(error2, authors){
        ...
        var html = template.HTML(topic[0].title, list,
          ...
          <p>
            <input type="next" name="title" placeholder="title" value="${topic[0].title}">
          </p>
          <p>
            <textarea name="description" style="width:300px;height:200px;"
            placeholder="description">${topic[0].description}</textarea>
          </p>
          <p>
